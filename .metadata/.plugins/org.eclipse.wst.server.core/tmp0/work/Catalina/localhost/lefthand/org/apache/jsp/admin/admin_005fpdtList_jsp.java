 ...
 * Generated at: 2021-12-12 10:38:36 UTC
...
if (adminInfo == null) {
 ...
 if (adminPdtPageInfo.getSchtype().equals("isview")) { 
      ...
      out.write("\t\t\t\t<li><select name=\"\" class=\"hand\" onchange=\"if(this.value) location.href=(this.value);\">\r\n");
      out.write("\t\t\t\t\t<option value=\"\">전체</option>\r\n");
      out.write("\t\t\t\t\t<option value=\"admin_pdt_list.adminpdt");
      out.print(args );
      out.write("&sort=datea\" ");
 if (adminPdtPageInfo.getSort().equals("datea")) { 
      out.write("selected=\"selected\" ");
 } 
 ...
 if (adminPdtPageInfo.getSort().equals("dated")) { 
      out.write("selected=\"selected\" ");
 } 
...
if(pdtList.size() > 0 && adminPdtPageInfo.getRcnt() > 0){	// 보여줄 게시글 목록이 있으면
	...
	for (int i = 0; i < pdtList.size(); i++){		
      ...
      out.write("\r\n");
      out.write("\t\t<tr align=\"center\" height=\"30\" onmouseover=\"this.style.background = '#efefef';\" onmouseout=\"this.style.background = '';\">\r\n");
      out.write("\t\t<td>");
      out.print(num );
      out.write("</td> \r\n");
      out.write("\t\t<td>");
      ...
      out.write("</td>\r\n");
      out.write("\t\t<td onmouseover=\"chgunderline\">");
      out.print(rlnk + pl.getPi_review() + "</a>" );
      out.write("</td>\r\n");
      out.write("\t\t<td>");
      ...
      out.write("</td>\r\n");
      out.write("\t\t<td onmouseover=\"chgunderline\">\r\n");
      out.write("\t\t<a onclick=\"window.open(this.href, '_blank', 'width=430px ,height=300px, toolbars=no, scrollbars=yes, top=50%, left=500%'); return false;\"\r\n");
      out.print(hlnk + "히스토리 </a>" );
      out.write("</td></tr>\r\n");
