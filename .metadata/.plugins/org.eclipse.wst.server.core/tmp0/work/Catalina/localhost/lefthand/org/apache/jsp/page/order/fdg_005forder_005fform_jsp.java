 ...
 * Generated at: 2021-12-06 05:45:57 UTC
...
public final class fdg_005forder_005fform_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if (memberInfo != null)	isLogin = true;
 ...
 if(sch_kind.equals("도전")) { 
      ...
      out.write("<form name=\"frmOrder\" action=\"fdg_order_proc.ord\" method=\"post\">\r\n");
      out.write("<h3>펀딩 정보</h3>\r\n");
      out.write("<div class=\"box\">\r\n");
      out.write("<table width=\"100%\" cellpadding=\"10\" cellspacing=\"0\" id=\"cartTable\">\r\n");
      out.write("<tr>\r\n");
      out.write("<th width=\"15%\">펀딩</th><th width=\"*\">펀딩명</th><th width=\"20%\">단가</th>\r\n");
...
if (fdg != null) {	// 구매할 상품이 있으면
      ...
      out.write("<td><img src=\"page/funding/img/");
      ...
      out.write("</td>\r\n");
      out.write("<td>");
      out.print(formatter.format(fdg.getFi_price()) );
      out.write("원</td>\r\n");
      out.write("<td>");
      out.print(fdg.getOcnum() );
      out.write("</td>\r\n");
      out.write("<td><strong class=\"highlight2\">");
      out.print(formatter.format(fdg.getFi_price() * fdg.getOcnum()) );
	...
	out.close();
      ...
      out.write("\" />\r\n");
      out.write("\t<input type=\"hidden\" name=\"ocnum\" value=\"");
      out.print(fdg.getOcnum() );
      out.write("\" />\r\n");
...
String[] arrPhone = memberInfo.getMi_phone().split("-");
      ...
      out.write("\r\n");
      out.write("<tr><th>받는 분</th><td><input type=\"text\" name=\"foi_name\" value=\"");
      out.print(memberInfo.getMi_name() );
      out.write("\" /></td></tr>\r\n");
      out.write("<tr>\r\n");
      out.write("\t<th>연락처</th>\r\n");
 ...
 if (arrPhone[0].equals("019")) { 
      ...
      out.write("\t<th>주소</th>\r\n");
      out.write("\t<td>\r\n");
      out.write("\t\t<input type=\"text\" name=\"foi_zip\" id=\"poi_zip\" size=\"5\" readonly value=\"");
      out.print(zip );
      out.write("\" />\r\n");
      out.write("\t\t<input type=\"button\" onclick=\"findAddr()\" value=\"우편번호 찾기\"><br>\r\n");
      out.write("\t\t<input type=\"text\" name=\"foi_addr1\" id=\"poi_addr1\" value=\"");
      out.print(addr1 );
      out.write("\" /><br />\r\n");
      out.write("\t\t<input type=\"text\" name=\"foi_addr2\" id=\"poi_addr2\" value=\"");
      out.print(addr2 );
      out.write("\" />\r\n");
      out.write("\t</td>\r\n");
      out.write("</tr>\r\n");
      ...
      out.write("<table width=\"100%\" cellpadding=\"10\" cellspacing=\"0\" id=\"deliTable\">\r\n");
      out.write("<tr>\r\n");
      out.write("\t<th width=\"20%\">결제수단</th>\r\n");
      out.write("\t<td>\r\n");
      out.write("\t\t<input type=\"radio\" name=\"foi_payment\" value=\"A\" id=\"payA\" checked=\"checked\" /><label for=\"payA\"> 카드 결제</label>&nbsp;&nbsp;\r\n");
      out.write("\t\t<input type=\"radio\" name=\"foi_payment\" value=\"B\" id=\"payB\" /><label for=\"payB\"> 휴대폰 결제</label>&nbsp;&nbsp;\t\r\n");
      out.write("\t\t<p id=\"caution\">* 펀딩 기간 종료일까지 목표펀딩금액이 달성되지 못할 경우 결제하신 금액은 자동으로 환불 처리됩니다. (펀딩 종료일 후 최대 7일)</p>\r\n");
      out.write("\t</td>\r\n");
      out.write("</tr>\r\n");
      out.write("<tr align=\"center\">\r\n");
