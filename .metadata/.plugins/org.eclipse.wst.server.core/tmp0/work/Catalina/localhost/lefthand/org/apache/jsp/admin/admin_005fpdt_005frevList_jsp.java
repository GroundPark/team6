 ...
 * Generated at: 2021-12-13 05:20:11 UTC
...
public final class admin_005fpdt_005frevList_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String piid = request.getParameter("piid");
      ...
      out.write("section #sort { float:right; padding-right:40px; margin-bottom:10px; }\r\n");
      out.write("section #search { width:100px; }\r\n");
      out.write(".hide {display:none;}\r\n");
      out.write(".review .show { display:table-row !important; } \r\n");
      out.write(".td {cursor:pointer;}  \r\n");
      out.write("</style>\r\n");
      out.write("<script>\r\n");
      out.write("function chView(rlidx, piid, rid, val) {\r\n");
      out.write("\t// 댓글 게시여부 변경 함수(rlidx: 후기 글번호, piid: 상품 아이디, rid: 회원ID, val: 댓글 현재 게시상태)\r\n");
      out.write("\t\t$.ajax({\r\n");
      out.write("\t\t\ttype : \"POST\", \r\n");
      out.write("\t\t\turl : \"/lefthand/chview\", \r\n");
      out.write("\t\t\tdata : {\"rlidx\" : rlidx, \"piid\": piid, \"miid\": rid, \"view\" : val }, \r\n");
...
if (adminInfo == null) {
	...
	out.close();
      ...
      out.write("\t\t    <h2>");
      out.print(piid );
      out.write(" 상품 후기 관리</h2>\r\n");
      out.write("\t\t    <form name =\"frmSort\" method=\"get\">\r\n");
      out.write("\t\t    <input type=\"hidden\" name=\"sort\" value=\"");
      out.print(adminPdtPageInfo.getSort() );
      out.write("\" />\r\n");
      out.write("\t\t\t<ul id=\"sort\">\r\n");
      out.write("\t\t\t\t<li><select name=\"sort\" class=\"hand\" onchange=\"if(this.value) location.href=(this.value);\">\r\n");
      out.write("\t\t\t\t\t<option value=\"전체\">전체</option>\r\n");
      out.write("\t\t\t\t\t<option value=\"admin_pdt_rev_list.adminpdt?piid=");
      out.print(piid );
      out.write("&sort=idxa\" ");
 if (adminPdtPageInfo.getSort().equals("idxa")) { 
      out.write("selected=\"selected\" ");
 } 
      out.write(" >등록일-오름차순</option>\r\n");
      out.write("\t\t\t\t\t<option value=\"admin_pdt_rev_list.adminpdt?piid=");
      out.print(piid );
      out.write("&sort=idxd\" ");
 if (adminPdtPageInfo.getSort().equals("idxd")) { 
      out.write("selected=\"selected\" ");
 } 
      out.write(">등록일-내림차순</option>\r\n");
      out.write("\t\t\t\t</select></li>\r\n");
      out.write("\t\t\t</ul>\r\n");
      out.write("\t\t\t</form>\r\n");
      out.write("\t\t\t<table width=\"900\" cellpadding=\"7\" cellspacing=\"0\" id=\"brd\" class=\"review\">\r\n");
      out.write("\t\t\t<tr height=\"30\">\r\n");
      out.write("\t\t\t<th width=\"5%\">번호</th><th width=\"6%\">후기번호</th><th width=\"8%\">작성자</th><th width=\"8%\">평점</th><th width=\"8%\">좋아요</th>\r\n");
      out.write("\t\t\t<th width=\"*%\">내용</th><th width=\"15%\">날짜</th><th width=\"10%\">게시여부</th>\r\n");
      out.write("\t\t\t</tr>\r\n");
...
if(reviewList.size() > 0 && adminPdtPageInfo.getRcnt() > 0){	// 보여줄 후기 목록이 있으면
	...
	for (int i = 0; i < reviewList.size(); i++){		
      ...
      out.write("\t\tonmouseover=\"this.style.background = '#efefef';\" onmouseout=\"this.style.background = '';\" >\r\n");
      out.write("\t\t<td>");
      out.print(num );
      out.write("</td> \r\n");
      out.write("\t\t<td>");
      ...
      out.write("</td>\r\n");
      out.write("\t\t<td>");
      out.print(rl.getRl_date().substring(0,11));
      out.write("</td>\r\n");
      out.write("\t\t<td>\r\n");
      out.write("\t\t\t<select name=\"view\" onchange=\"chView(");
      out.print(rl.getRl_idx() );
      out.write(' ');
      out.write(',');
      out.write('\'');
 ...
 if (rl.getRl_isview().equals("y")) { 
      out.write(" selected=\"selected\" ");
 } 
      out.write(">Y</option>\r\n");
      out.write("\t\t\t\t<option value=\"n\" ");
 if (rl.getRl_isview().equals("n")) { 
      out.write(" selected=\"selected\" ");
 } 
      out.write(">N</option>\r\n");
      out.write("\t\t\t</select>\r\n");
