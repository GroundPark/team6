 ...
 * Generated at: 2021-12-12 10:08:07 UTC
...
public final class admin_005forder_005fpdtList_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if (adminInfo == null) {
	...
	out.close();
      ...
      out.write("\t<section>\r\n");
      out.write("\t<h2>상품 주문 목록</h2>\r\n");
      out.write("\t<h2>검색 창</h2>\r\n");
      out.write("\t<form name =\"frmSch\" method=\"get\">\r\n");
      out.write("\t<input type=\"hidden\" name=\"sort\" value=\"");
      out.print(adminOrderPdtPageInfo.getSort() );
      out.write("\" /> \r\n");
      out.write("\t<ul id=\"cata\">\r\n");
      out.write("\t\t<li><select name=\"schtype\" class=\"hand\">\r\n");
      out.write("\t\t\t \t<option value=\"miid\" ");
 if (adminOrderPdtPageInfo.getSchtype().equals("miid")) { 
      out.write(" selected=\"selected\" ");
 } 
      out.write(">회원ID</option> \r\n");
      out.write("\t\t\t\t<option value=\"poiid\" ");
 if (adminOrderPdtPageInfo.getSchtype().equals("poiid")) { 
      out.write(" selected=\"selected\" ");
 } 
      out.write(">주문번호</option> \r\n");
      out.write("\t\t\t\t<option value=\"poistatus\" ");
 if (adminOrderPdtPageInfo.getSchtype().equals("poistatus")) { 
      out.write(" selected=\"selected\" ");
 } 
      out.write(">주문상태</option>\r\n");
      out.write("\t\t</select></li>\r\n");
      out.write("\t\t<li><input type=\"text\" name=\"keyword\" value=\"");
      out.print(adminOrderPdtPageInfo.getKeyword() );
      out.write("\"  /></li>\r\n");
      ...
      out.write("\t\t\t<option value=\"order_pdt.adminord");
      out.print(args );
      out.write("&sort=datea\" \r\n");
      out.write("\t\t\t\t");
 if (adminOrderPdtPageInfo.getSort().equals("datea")) { 
      out.write(" selected=\"selected\" ");
 } 
      ...
      out.write("\t\t\t\t");
 if (adminOrderPdtPageInfo.getSort().equals("dated")) { 
      out.write(" selected=\"selected\" ");
 } 
...
if(orderList.size() > 0 && adminOrderPdtPageInfo.getRcnt() > 0){	// 보여줄 게시글 목록이 있으면
	...
	for (int i = 0; i < orderList.size(); i++) {		
      ...
      out.print(oi.getPoi_id() );
      out.write("</td>\r\n");
      out.write("\t<td>");
      out.print(oi.getMi_id() );
      out.write("</td> \r\n");
      out.write("\t<td>");
      out.print(formatter.format(oi.getPoi_pay()));
      out.write("</td> \r\n");
      out.write("\t<td>");
      out.print(oi.getPoi_date() );
      out.write("</td> \r\n");
      out.write("\t<td>");
      out.print(status );
      out.write("</td>\r\n");
