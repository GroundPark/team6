 ...
 * Generated at: 2021-11-26 18:48:00 UTC
...
// 로그인 후 이동할 페이지 주소로, 없는 경우 빈 문자열로 지정
      ...
      out.write("\t<h2>회원<br />로그인</h2>\r\n");
      out.write("\t\t<div class=\"col\" id=\"col1\">\r\n");
      out.write("\t\t\t<label for=\"uid\">아이디</label><input type=\"text\" name=\"uid\" id=\"uid\" class=\"txt\" value=\"chan135\" />\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t\t<div class=\"col\" id=\"col2\">\r\n");
      out.write("\t\t\t<label for=\"pwd\">비밀번호</label><input type=\"password\" name=\"pwd\" id=\"pwd\" class=\"txt\" value=\"Kwang1\" />\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t\t<div>\r\n");
