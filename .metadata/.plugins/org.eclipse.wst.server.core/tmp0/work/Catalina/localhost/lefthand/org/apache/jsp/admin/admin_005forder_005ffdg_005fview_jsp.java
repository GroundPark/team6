 ...
 * Generated at: 2021-12-12 10:09:40 UTC
...
public final class admin_005forder_005ffdg_005fview_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if (adminInfo == null) {
	...
	out.close();
      ...
      out.write("\t<section>\r\n");
      out.write("\t<h2>펀딩 주문 내역</h2>\r\n");
      out.write("\t<form name=\"frmAdminOrderFdg\" action=\"order_fdg_proc.adminord\" method=\"post\" class=\"pdtForm\">\t\r\n");
      out.write("\t\t<div id=\"box\">\r\n");
      out.write("\t\t\t<div class=\"form_area\">\t\r\n");
      out.write("\t\t\t\t<div class=\"lablearea\"><label for =\"foi_id\">주문번호</label></div>\r\n");
      out.write("\t\t\t\t<div class=\"fieldarea\"><input type=\"text\" name=\"foi_id\"  id=\"foi_id\" value=\"");
      out.print(fdgOrd.getFoi_id() );
      out.write("\" readonly=\"readonly\" /></div>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t\t<div class=\"form_area\">\t\t\t\t\r\n");
      out.write("\t\t\t\t<div class=\"lablearea\"><label for =\"foi_date\">주문일</label></div>\r\n");
      out.write("\t\t\t\t<div class=\"fieldarea\"><input type=\"text\" name=\"foi_date\"  id=\"foi_date\" value=\"");
      out.print(fdgOrd.getFoi_date() );
      out.write("\" readonly=\"readonly\" /></div>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t\t<table id=\"pdtList\" width=\"90%\" cellpadding=\"5\" cellspacing=\"0\">\r\n");
      out.write("\t\t\t<tr><th width=\"20%\">펀딩아이디</th><th width=\"*\">펀딩명</th><th width=\"15%\">수량(ea)</th><th width=\"20%\">단가(원)</th></tr>\r\n");
 for (FdgOrderDetail detail : detailList) { 
      out.write("\r\n");
      out.write("\t\t\t<tr align=\"center\">\r\n");
      out.write("\t\t\t<td>");
      out.print(detail.getFi_id() );
      out.write("</td>\r\n");
      out.write("\t\t\t<td>");
      out.print(detail.getFod_pname() );
      out.write("</td>\r\n");
      out.write("\t\t\t<td>");
      out.print(detail.getFod_cnt() );
      out.write("</td>\r\n");
      out.write("\t\t\t<td>");
      out.print(formatter.format(detail.getFod_pprice()) );
      out.write("</td>\r\n");
      out.write("\t\t\t</tr>\r\n");
 } 
      out.write("\r\n");
      ...
      out.print(fdgOrd.getMi_id() );
      out.write("\" /></div>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t\t<div class=\"form_area\">\t\t\t\t\r\n");
      out.write("\t\t\t\t<div class=\"lablearea\"><label for =\"foi_name\">주문자명</label></div>\r\n");
      out.write("\t\t\t\t<div class=\"fieldarea\"><input type=\"text\" name=\"foi_name\"  id=\"foi_name\" readonly=\"readonly\" value=\"");
      out.print(fdgOrd.getFoi_name() );
      out.write("\" /></div>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t\t<div class=\"form_area\">\t\t\t\t\r\n");
      out.write("\t\t\t\t<div class=\"lablearea\"><label for =\"foi_phone\">전화번호</label></div>\r\n");
      out.write("\t\t\t\t<div class=\"fieldarea\"><input type=\"text\" name=\"foi_phone\"  id=\"foi_phone\" value=\"");
      out.print(fdgOrd.getFoi_phone() );
      out.write("\" /></div>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t\t<div class=\"form_area\">\t\t\t\t\r\n");
      out.write("\t\t\t\t<div class=\"lablearea\"><label for =\"foi_zip\">주소</label></div>\r\n");
      out.write("\t\t\t\t<div class=\"fieldarea\"><input type=\"text\" name=\"foi_zip\"  id=\"foi_zip\" value=\"");
      out.print(fdgOrd.getFoi_zip() );
      out.write("\" /></div><br />\r\n");
      out.write("\t\t\t\t<div class=\"lablearea\"></div>\r\n");
      out.write("\t\t\t\t<div class=\"fieldarea\"><input type=\"text\" name=\"foi_addr1\"  id=\"foi_addr1\" value=\"");
      out.print(fdgOrd.getFoi_addr1() );
      out.write("\" /></div><br />\r\n");
      out.write("\t\t\t\t<div class=\"lablearea\"></div>\r\n");
      out.write("\t\t\t\t<div class=\"fieldarea\"><input type=\"text\" name=\"foi_addr2\"  id=\"foi_addr2\" value=\"");
      out.print(fdgOrd.getFoi_addr2() );
      out.write("\" /></div>\r\n");
      out.write("\t\t\t</div>\r\n");
...
if (fdgOrd.getAi_idx() != 0)	aiidx = fdgOrd.getAi_idx() + "";
      ...
      out.write("\r\n");
      out.write("\t\t\t<div class=\"form_area\">\t\t\t\t\r\n");
      out.write("\t\t\t\t<div class=\"lablearea\"><label for =\"foi_memo\">배송메모</label></div>\r\n");
      out.write("\t\t\t\t<div class=\"fieldarea\"><input type=\"text\" name=\"foi_memo\"  id=\"foi_memo\" value=\"");
      out.print(memo );
      out.write("\" /></div>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t\t<div class=\"form_area\">\t\t\t\t\r\n");
      out.write("\t\t\t\t<div class=\"lablearea\"><label for =\"foi_invoice\">송장번호</label></div>\r\n");
      out.write("\t\t\t\t<div class=\"fieldarea\"><input type=\"text\" name=\"foi_invoice\"  id=\"foi_invoice\" value=\"");
      out.print(invoice );
      out.write("\" /></div>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t\t<div class=\"form_area\">\t\t\t\t\r\n");
      out.write("\t\t\t\t<div class=\"lablearea\"><label for =\"foi_status\">주문상태</label></div>\t\t\t\t\r\n");
      out.write("\t\t\t\t<div class=\"fieldarea\">\r\n");
      out.write("\t\t\t\t<select name=\"foi_status\" id=\"comboBox\" >\r\n");
      out.write("\t\t\t\t\t<option value=\"a\" ");
 if(fdgOrd.getFoi_status().equals("a")) { 
      out.write(" selected=\"selected\" ");
 }
      out.write(">입금대기중</option>\r\n");
      out.write("\t\t\t\t\t<option value=\"b\" ");
 if(fdgOrd.getFoi_status().equals("b")) { 
      out.write(" selected=\"selected\" ");
 }
      out.write(">결제완료</option>\r\n");
      out.write("\t\t\t\t\t<option value=\"c\" ");
 if(fdgOrd.getFoi_status().equals("c")) { 
      out.write(" selected=\"selected\" ");
 }
      out.write(">물품제작중</option>\r\n");
      out.write("\t\t\t\t\t<option value=\"d\" ");
 if(fdgOrd.getFoi_status().equals("d")) { 
      out.write(" selected=\"selected\" ");
 }
      out.write(">배송준비중</option>\r\n");
      out.write("\t\t\t\t\t<option value=\"e\" ");
 if(fdgOrd.getFoi_status().equals("e")) { 
      out.write(" selected=\"selected\" ");
 }
      out.write(">배송중</option>\r\n");
      out.write("\t\t\t\t\t<option value=\"f\" ");
 if(fdgOrd.getFoi_status().equals("f")) { 
      out.write(" selected=\"selected\" ");
 }
      ...
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t\t<div class=\"form_area\">\t\t\t\t\r\n");
      out.write("\t\t\t\t<div class=\"lablearea\"><label for =\"foi_price\">결제액</label></div>\r\n");
      out.write("\t\t\t\t<div class=\"fieldarea\"><input type=\"text\" name=\"foi_price\"  id=\"foi_price\" readonly=\"readonly\" value=\"");
      out.print(formatter.format(fdgOrd.getFoi_pay()) );
      out.write(" 원\" /></div>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t\t<div class=\"form_area\">\t\t\t\t\r\n");
      out.write("\t\t\t\t<div class=\"lablearea\"><label for =\"foi_modify\">최종 수정일</label></div>\r\n");
      out.write("\t\t\t\t<div class=\"fieldarea\"><input type=\"text\" name=\"foi_modify\"  id=\"foi_modify\" readonly=\"readonly\" value=\"");
      out.print(fdgOrd.getFoi_modify() );
      out.write("\" /></div>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t\t<div class=\"form_area\">\t\t\t\t\r\n");
      ...
      out.write("\t\t\t\t<input type=\"button\" class=\"btn\" value=\"돌아가기\" onclick=\"location.href ='order_fdg.adminord';\" style=\"width:120px; height:25px;\"/>\r\n");
