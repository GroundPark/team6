 ...
 * Generated at: 2021-11-28 08:16:28 UTC
...
public final class chal_005ffunding_005fview_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/page/challenge/../../include/header.jsp", Long.valueOf(1638031216993L));
  }
...
// else if (notice.getNl_kind().equals("d"))		kind="보도자료";
      ...
      out.write("\t// 댓글을 update하고 이 페이지를 새로고침하여 표시하는게 쉬운가? 좀 걸려도 ajax같은 걸 써서 해야하는가? 보류...\r\n");
...
if (memberInfo != null)	isLogin = true;
 ...
 if(memberInfo == null) { 
      ...
      out.print(challengeDetail.getCi_sdate() );
      out.write(' ');
      out.write('~');
      out.write(' ');
      out.print(challengeDetail.getCi_edate() );
      out.write("</p>\r\n");
      ...
      out.write("</p>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t<button class=\"sym_button\"><img src=\"img/heart_empty.png\" width=\"100\" height=\"90\" /><br /><br /><p style=\"font-size:20px\">공감( ");
      ...
      out.write("\r\n");
      out.write("\t\t\t<!-- TODO 더미데이터 작성할때 우리 평범하게 게시판 글싸는것처럼 한다음 스타일 어떻게 할지 생각 : 지금은 그냥 가운데 정렬됨 -->\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t</section>\r\n");
