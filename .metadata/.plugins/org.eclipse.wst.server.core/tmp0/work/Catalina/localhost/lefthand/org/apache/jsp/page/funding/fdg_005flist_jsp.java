...
if (memberInfo != null)	isLogin = true;
 ...
 if(sch_kind.equals("도전")) { 
      ...
      out.write("\t<li>\r\n");
      out.write("\t\t<select onchange=\"fundingarray(this.value)\"> <!-- 전체(기본), 인기순, 최신순, 마감임박순으로 정렬 가능 -->\r\n");
      out.write("\t\t\t<option value=\"\">전체</option>\r\n");
      out.write("\t\t\t<option value=\"fdg_list.fdg");
      out.print(args );
      out.write("&sort=rated\">인기순</option>\r\n");
      out.write("\t\t\t<option value=\"fdg_list.fdg");
      out.print(args );
      out.write("&sort=sdated\">최신순</option>\r\n");
      out.write("\t\t\t<option value=\"fdg_list.fdg");
      out.print(args );
      out.write("&sort=edatea\">마감임박순</option>\r\n");
      out.write("\t\t</select>\r\n");
      out.write("\t</li>\r\n");
      out.write("</ul>\r\n");
