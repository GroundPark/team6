 ...
 * Generated at: 2021-12-12 15:42:06 UTC
...
public final class admin_005fchal_005ffunding_005freply_005flist_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if (adminInfo == null) {
	...
	out.close();
      ...
      out.write("\r\n");
      out.write("<script>\t\r\n");
      out.write("function chView(cridx, ciidx, miid, view) {\r\n");
      out.write("\t// 댓글 게시여부 변경 함수(cridx: 댓글 번호, ciidx: 글 번호, miid: 회원ID, val: 댓글 현재 게시상태)\r\n");
      out.write("\t\t$.ajax({\r\n");
      out.write("\t\t\ttype : \"POST\", \r\n");
      out.write("\t\t\turl : \"chal_manage_reply_up.admin\", \r\n");
      out.write("\t\t\tdata : {\"cridx\" : cridx, \"ciidx\": ciidx, \"miid\": miid, \"view\" : view }, \r\n");
      out.write("\t\t\tsuccess : function(chkRs) {\r\n");
      out.write("\t\t\t\tif (chkRs == 0)\talert(\"댓글 게시 여부 변경에 실패했습니다.\\n새로 고침 후 다시 시도해 주십시오.\");\r\n");
      out.write("\t\t\t\telse\t\t\t{\r\n");
      out.write("\t\t\t\t\tlocation.reload();\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t},\r\n");
      out.write("\t\t\terror : function(chkRs) {\r\n");
      out.write("\t\t\t\talert(\"실패  cridx: \" + cridx);\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t});\r\n");
      out.write("\t}\t\r\n");
      out.write("</script>\t\r\n");
      ...
      out.write("\t\t\t\t<select class=\"chalReply_search\" name=\"schtype\">\r\n");
      out.write("\t\t\t\t\t<option value=\"mi_id\" ");
 if (pageInfo.getSchtype().equals("mi_id")) { 
      out.write("selected = \"selected\"");
 } 
      out.write(">작성자</option> \r\n");
      out.write("\t\t\t\t\t<option value=\"cr_content\" ");
 if (pageInfo.getSchtype().equals("cr_content")) { 
      out.write("selected = \"selected\"");
 } 
      out.write(">댓글 내용</option>\r\n");
 ...
 if (pageInfo.getSchtype().equals("ci_idx")) { 
      ...
      out.write("\" />\r\n");
      out.write("\t\t\t\t<input type=\"submit\" value=\"검색\" id=\"chalReply_submit\" class=\"chalReply_submit\" />\r\n");
      out.write("\t\t\t\t</form>\r\n");
      out.write("\t\t\t\t</li>\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t</ul>\r\n");
      ...
      out.write("\t\t\t<th width=\"8%\">댓글 번호</th><th width=\"8%\">글 번호</th><th width=\"10%\">작성자</th>\r\n");
      out.write("\t\t\t<th width=\"20%\">작성일시</th><th width=\"*%\">댓글내용</th><th width=\"8%\">게시여부</th>\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\r\n");
	...
	for(int i=0;i<adminChallengeReplyList.size(); i++){
      ...
      out.write("\r\n");
      out.write("<tr height=\"36\" align=\"center\" onmouseover=\"this.style.background='#efefef';\" \r\n");
      out.write("\tonmouseout=\"this.style.background='';\" >\r\n");
      out.write("<td>");
      out.print(acl.getCr_idx() );
      out.write("</td><td>");
      out.print(acl.getCi_idx() );
      out.write("</td><td>");
      out.print(acl.getMi_id() );
      out.write("</td>\r\n");
      out.write("<td>");
      out.print(acl.getCr_date() );
      out.write("</td><td>");
      out.print(replyContent );
      out.write("</td>\r\n");
      out.write("<td>\r\n");
      out.write("\r\n");
 if (acl.getCr_isview().equals("y")){ 
      out.write("\r\n");
      out.write("<select name=\"view\" style=\"cursor:pointer\" onchange=\"chView(");
      out.print(acl.getCr_idx() );
      out.write(' ');
      out.write(',');
      out.print(acl.getCi_idx() );
