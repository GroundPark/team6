...
if (adminInfo == null) {
	...
	out.close();
      ...
      out.write('\n');
      if (true) {
        _jspx_page_context.forward("/schedule.bbs");
        return;
      }
      out.write("\r\n");
      out.write("<!--\r\n");
      out.write("로그인 하고 첫 화면에 일정관리를 보여줘야하는데 로그인에는 act가 없어서 데이터를 받아오기가 여의치않아서 곧바로 이동시키는것.\r\n");
      out.write("프론트의 index.jsp와 같은 기능이라 보면 됨.\r\n");
      out.write("-->\r\n");
      out.write("</body>\r\n");
      out.write("<!-- 이 모양 유지할것 -->\r\n");
      out.write("</html>");
