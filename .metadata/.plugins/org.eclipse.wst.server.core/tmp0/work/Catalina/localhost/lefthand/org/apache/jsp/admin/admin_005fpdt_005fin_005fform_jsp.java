 ...
 * Generated at: 2021-12-13 05:21:26 UTC
...
if (adminInfo == null) {
	...
	out.close();
      ...
      out.write("\r\n");
      out.write("\t// files 로 해당 파일 정보 얻기.\r\n");
      out.write("\tvar file = f.files;\r\n");
      out.write("\r\n");
      out.write("\t// file[0].name 은 파일명 입니다.\r\n");
      out.write("\t// 정규식으로 확장자 체크\r\n");
      out.write("\t// 패턴/ 플래그 => 패턴에 있는 문자열들 찾기위함\r\n");
      out.write("\t// \\. : 마침표 자체를 매칭되는 문자열로 사용하기 위함   /문자열 $ =>문자열의 끝에서 일치(gif,jpg... 로 끝남)\r\n");
      out.write("\t// i: 대소문자 구분없이 검색, test: 매칭된 문자열이 있는지 확인하는 메소드(문자열 있으면 true, 없으면 false)\r\n");
      out.write("\tif(!/\\.(gif|jpg|jpeg|png)$/i.test(file[0].name)) alert('gif, jpg, png 파일만 선택해 주세요.\\n\\n현재 파일 : ' + file[0].name);\r\n");
      out.write("\r\n");
      out.write("\t// 체크를 통과했다면 종료.\r\n");
      out.write("\telse return;\r\n");
      out.write("\r\n");
      out.write("\t// 체크에 걸리면 선택된  내용 취소 처리를 해야함.\r\n");
      out.write("\t// 파일선택 폼의 내용은 스크립트로 컨트롤 할 수 없습니다.\r\n");
      out.write("\t// 그래서 그냥 새로 폼을 새로 써주는 방식으로 초기화 합니다.\r\n");
      ...
      out.write("input[type=file] { width:350px; }\r\n");
      ...
      out.write("\t\t\t\tenctype=\"multipart/form-data\" onsubmit=\"return chkVal(this);\">\t\r\n");
      out.write("\t\t\t<div>\r\n");
      out.write("\t\t\t\t<div class=\"form_area\">\t\r\n");
      out.write("\t\t\t\t\t<div class=\"lablearea\"><label for =\"pi_id\" >상품 ID</label></div>\r\n");
      out.write("\t\t\t\t\t<div class=\"fieldarea\"><input type=\"text\" name=\"pi_id\" value=\"a113\"/></div>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t<div class=\"form_area\">\t\t\t\t\r\n");
      ...
      out.write("\t\t\t\t\t<div class=\"fieldarea\"><input type=\"text\" name=\"pi_name\"  id=\"pi_name\" value=\"아동용 가위\"/></div>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t<div class=\"form_area\">\t\t\t\t\r\n");
      out.write("\t\t\t\t\t<div class=\"lablearea\"><label for =\"pi_img1\" >상품이미지1</label></div>\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t<div class=\"fieldarea\"><input type=\"file\" name=\"pi_img1\"  id=\"pi_img1\" onchange=\"checkFile(this)\" /></div>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t<div class=\"form_area\">\t\t\t\t\r\n");
      out.write("\t\t\t\t\t<div class=\"lablearea\"><label for =\"pi_img2\" >상품이미지2</label></div>\r\n");
      out.write("\t\t\t\t\t<div class=\"fieldarea\"><input type=\"file\" name=\"pi_img2\" id=\"pi_img2\" onchange=\"checkFile(this)\" /></div>\r\n");
      out.write("\t\t\t\t<div class=\"form_area\">\t\t\t\t\r\n");
      out.write("\t\t\t\t\t<div class=\"lablearea\"><label for =\"pi_img3\" >상품이미지3</label></div>\r\n");
      out.write("\t\t\t\t\t<div class=\"fieldarea\"><input type=\"file\" name=\"pi_img3\"  id=\"pi_img3\" onchange=\"checkFile(this)\" /></div>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t<div class=\"form_area\">\t\t\t\t\r\n");
      out.write("\t\t\t\t\t<div class=\"lablearea\"><label for =\"pi_desc\" >설명이미지</label></div>\r\n");
      out.write("\t\t\t\t\t<div class=\"fieldarea\"><input type=\"file\" name=\"pi_desc\"  id=\"pi_desc\" onchange=\"checkFile(this)\" /></div>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t<div class=\"form_area\">\t\t\t\t\r\n");
      out.write("\t\t\t\t\t<div class=\"lablearea\"><label for =\"pi_price\" >상품가격</label></div>\r\n");
      out.write("\t\t\t\t\t<div class=\"fieldarea\"><input type=\"text\" name=\"pi_price\"  id=\"pi_price\" onkeyup=\"call();\" value=\"10000\"/></div>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t<div class=\"form_area\">\t\t\t\t\r\n");
      out.write("\t\t\t\t\t<div class=\"lablearea\"><label for =\"pi_discount\">할인율</label></div>\r\n");
      out.write("\t\t\t\t\t<div class=\"fieldarea\"><input type=\"text\" name=\"pi_discount\"  id=\"pi_discount\" onkeyup=\"call();\" value=\"0.1\"/></div>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t<div class=\"form_area\">\t\t\t\t\r\n");
      out.write("\t\t\t\t\t<div class=\"lablearea\"><label for =\"price3\">판매가격</label></div>\r\n");
      out.write("\t\t\t\t\t<div class=\"fieldarea\"><input type=\"text\" name=\"price3\"  id=\"price3\" value=\"9000\"/></div>\r\n");
      out.write("\t\t\t\t<div class=\"form_area\">\t\t\t\t\r\n");
      out.write("\t\t\t\t\t<div class=\"lablearea\"><label for =\"pi_stock\">재고수량</label></div>\r\n");
      out.write("\t\t\t\t\t<div class=\"fieldarea\"><input type=\"text\" name=\"pi_stock\"  id=\"pi_stock\" value=\"100\"/></div>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t<div class=\"form_area\">\t\t\t\t\r\n");
      ...
      out.write("\t\t\t\t\t<div class=\"fieldarea\">\t\t\r\n");
      out.write("\t\t\t\t\t<input type=\"radio\" name=\"pi_isview\" value=\"y\" id=\"soldy\"/><label for =\"soldy\">Y</label>\r\n");
      out.write("\t\t\t\t\t<input type=\"radio\" name=\"pi_isview\" value=\"n\" id=\"soldn\" checked=\"checked\"/><label for =\"soldn\">N</label>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t");
      ...
      out.print(adminInfo.getAi_idx() );
      out.write("\" style=\"text-align:center;\" readonly/></div>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t<p id=\"button_area\" style=\"width:1020px; margin-top:30px;\">\r\n");
      out.write("\t\t\t\t\t<input type=\"button\" value=\"취소\" onclick=\"location.href ='admin_pdt_list.adminpdt';\" style=\"width:170px; height:25px;\"/>\r\n");
      out.write("\t\t\t\t\t<input type=\"submit\" value=\"등록\" style=\"width:170px; height:25px;\"/>\r\n");
      out.write("\t\t\t\t</p>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t</div>\r\n");
