...
<form name="loginFrm" action="" method="post">
	<fieldset id="fldset">
		...
		<div class="col" id="col1">
			<label for="uid">ADMIN ID</label><input type="text" name="uid" id="uid" class="txt" placeholder="&nbsp;아이디" />
		</div>
		<div class="col" id="col2">
			<label for="pwd">PASSWORD&nbsp;</label><input type="password" name="pwd" id="pwd" class="txt" placeholder="&nbsp;비밀번호" />
		</div>
		<div>
