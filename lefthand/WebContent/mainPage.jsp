...
<article id="mainSlide">					<!-- 메인 슬라이드 시작 -->
	<div class="slideshow">
		<div class="slideshow-slides">
			<a href="#" class="slide" id="slide-1"><img src="img/slide-1.jpg" width="1200" height="465" /></a>
			<a href="#" class="slide" id="slide-2"><img src="img/slide-2.jpg" width="1200" height="465" /></a>
			<a href="#" class="slide" id="slide-3"><img src="img/slide-3.jpg" width="1200" height="465" /></a>
