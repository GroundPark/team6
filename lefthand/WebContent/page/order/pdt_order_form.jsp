...
<td><%=pdt.getPoc_cnt() %></td>
<td><del><%=formatter.format(pdt.getPi_price() * pdt.getPoc_cnt())  %></del><br />
<strong class="highlight2"><%=formatter.format(((pdt.getPi_price() * (1 - pdt.getPi_discount())) * pdt.getPoc_cnt()))%>원</strong></td>
</tr>
<%
