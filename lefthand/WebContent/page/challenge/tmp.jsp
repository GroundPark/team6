<<<<<<< HEAD:.metadata/.plugins/org.eclipse.core.resources/.history/af/e0b249f6094e001c13e1f2d7281ad122
...
<article class="chalfunding_detail">
	<div class="chalfunding_detail_inner">
		...
		<section class="chg_top">
			<div class="chg_top_area">
				<div class="chg_titl_area">
					...
					<p class="period_area">2021년 뭐지 이건</p>
				</div>
		...
		<section class="chg_info">
			<div class="info_img_area"><img src="userimg/<%=challenge.getCi_img() %>" width="500" height="500" /><p><%=challenge.getCi_content() %></div>
		</section>
		<!-- 도전펀딩  설명 영역 종료 -->
		<!-- 도전펀딩 채팅 영역 시작 -->
...
>>>>>>> fd330b29a7bb233365e6064b814ad3e79487d839:lefthand/WebContent/page/challenge/chal_funding_detail.jsp
