...
public class AdminFundingUpAct implements Action {
...
//		pageInfo.setSchtype(schtype);
		...
		AdminFundingList adminFunding = adminFundingUpSvc.getNoticeInfo(idx);
		
		
		if(adminFunding == null) {		// 해당 게시글이 없으면
		...
		request.setAttribute("adminFunding", adminFunding);
		request.setAttribute("pageInfo", pageInfo);
				
		ActionForward forward = new ActionForward();
		forward.setPath("/admin/admin_funding_up.jsp");
